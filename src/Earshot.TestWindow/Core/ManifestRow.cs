...
// One variant of test 10 (test-gui.md section 6.1): its own TestId and its own two halves.
internal sealed record ManifestVariant(int Variant, string TestId, PowerCycleRequirement PowerCycleRequirement);
...
internal sealed class ManifestRow
{
    ...
    public required string WhatItProves { get; init; }
