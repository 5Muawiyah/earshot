...
public sealed class DiagTests
{
    ...
    [DataRow("diag", "ks", "reconnect", "src", "buffer4")]
    [DataRow("diag", "ks", "disconnect", "all", "buffer4", "--out", "C:\\temp\\ks.json")]
    [DataRow("diag", "gate", "block")]
    [DataRow("diag", "gate", "status")]
    [DataRow("diag", "gate", "protect-off")]
    [DataRow("diag", "gate", "set-device", "0A1B2C3D4E8C")]
    ...
    [DataRow("diag", "ks", "reconnect", "src", "Buffer4")]
    [DataRow("diag", "ks", "reconnect", "src", "buffer4", "buffer4")]
    ...
    [DataRow("diag", "gate", "set-device", "0A1B2C3D4E8C;calc")]
    ...
    [DataRow("gate", "allow")]
    [DataRow("gate", "set-device", "0A1B2C3D4E8C")]
